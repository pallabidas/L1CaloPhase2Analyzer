...
process.source = cms.Source("PoolSource",
                            ...
                            fileNames = cms.untracked.vstring("root://cms-xrd-global.cern.ch//store/mc/Phase2HLTTDRSummer20ReRECOMiniAOD/VBFHToTauTau_M125_14TeV_powheg_pythia8_correctedGridpack_tuneCP5/FEVT/PU200_111X_mcRun4_realistic_T15_v1-v1/120000/084C8B72-BC64-DE46-801F-D971D5A34F62.root",
                                                              "root://cms-xrd-global.cern.ch//store/mc/Phase2HLTTDRSummer20ReRECOMiniAOD/VBFHToTauTau_M125_14TeV_powheg_pythia8_correctedGridpack_tuneCP5/FEVT/PU200_111X_mcRun4_realistic_T15_v1-v1/280000/7771879B-1E79-E44A-897D-F27D32F0F555.root",
                                                        ),
...
#process.source.eventsToProcess = cms.untracked.VEventRange("1:290134")
...
process.schedule = cms.Schedule(process.L1simulation_step, process.pL1EG, process.end)
