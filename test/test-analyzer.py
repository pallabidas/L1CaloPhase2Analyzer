...
process.source = cms.Source("PoolSource",
                            fileNames = cms.untracked.vstring(
                                "root://cms-xrd-global.cern.ch://store/mc/Phase2Spring24DIGIRECOMiniAOD/TT_TuneCP5_14TeV-powheg-pythia8/GEN-SIM-DIGI-RAW-MINIAOD/PU200_Trk1GeV_140X_mcRun4_realistic_v4-v2/2560000/fa52b2f3-4162-4072-bd02-2cf33f5bc800.root",),
...
process.load('L1Trigger.L1CaloTrigger.l1tPhase2CaloToCorrelatorTM18_cfi')
...
process.pL1EG = cms.Path( process.l1tPhase2L1CaloEGammaEmulator*process.l1tPhase2CaloPFClusterEmulator*process.l1tPhase2CaloJetEmulator*process.l1tPhase2CaloToCorrelatorTM18*process.l1NtupleProducer )
