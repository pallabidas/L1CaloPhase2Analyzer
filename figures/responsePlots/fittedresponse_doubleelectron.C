{
  ...
  f1.open("scale_pfcluster_doubleelectron_nofit.txt");
  string s;
  float yvalue, yerr;
  Float_t bins[] = {5, 10, 15, 20, 25, 30, 35, 40, 45, 50, 55, 60, 70, 80, 90};
  Int_t  binnum = 14;
  ...
  ifstream f2;
  f2.open("scale_pfcluster_doubleelectron_fitted.txt");
  string s1;
  float yvalue1, yerr1;
  ...
  latex->DrawLatex(0.54, 0.780, "#scale[0.8]{DoubleElectron Pt 1 to 100}");
  latex->DrawLatex(0.54, 0.720, "#scale[0.8]{Gen p_{T} > 5, |#eta^{Gen}| < 1.4841}");

  //c1->Update();

  //Tcan->cd();
  c1->SaveAs("/afs/cern.ch/work/p/pdas/www/emulator_phase2/12_3_0_pre4/doubleelectron/response_fitted.pdf");
  c1->SaveAs("/afs/cern.ch/work/p/pdas/www/emulator_phase2/12_3_0_pre4/doubleelectron/response_fitted.png");
