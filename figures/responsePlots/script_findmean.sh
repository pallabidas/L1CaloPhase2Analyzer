...
cat>test1.C<<EOF
{
  ...
  fstream out;
  out.open("scale_pfcluster.txt", fstream::in | fstream::out | fstream::app);
...
cat>test2.C<<EOF
{
  ...
  c1->SaveAs("/afs/cern.ch/work/p/pdas/www/emulator_phase2/12_3_0_pre4/singlepion/bugfix/response.pdf");
  c1->SaveAs("/afs/cern.ch/work/p/pdas/www/emulator_phase2/12_3_0_pre4/singlepion/bugfix/response.png");
