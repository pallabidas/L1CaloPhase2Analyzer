...
for range in 5 10 15 20 25 30 35 40 45 50 55 60 70 80 90; do
#for range in 45; do
...
void test1(){
  ...
  gStyle->SetOptStat(0);
  TFile *fdata1 = TFile::Open("hfile_doubleelectron.root");
  ...
  RooRealVar gamma_Z0("gamma_Z0_U", "Z0 width", 2.3, 0., 2., "GeV"); // gamma
  ...
  fstream out2;
  out2.open("scale_pfcluster_doubleelectron_fitted.txt", fstream::in | fstream::out | fstream::app);
  ...
  c1->SaveAs("/afs/cern.ch/work/p/pdas/www/emulator_phase2/12_3_0_pre4/doubleelectron/reso${range}.pdf");
  c1->SaveAs("/afs/cern.ch/work/p/pdas/www/emulator_phase2/12_3_0_pre4/doubleelectron/reso${range}.png");
